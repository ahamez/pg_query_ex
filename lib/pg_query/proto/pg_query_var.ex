...
defmodule PgQuery.Var do
  ...
  (
    ...
    defp encode_varattnosyn({acc, acc_size}, msg) do
      if msg.varattnosyn == 0 do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_int32(msg.varattnosyn)
    ...
    defp encode_varnosyn({acc, acc_size}, msg) do
      if msg.varnosyn == 0 do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_uint32(msg.varnosyn)
