...
defmodule PgQuery.ScalarArrayOpExpr do
  ...
  @type t :: %__MODULE__{
          ...
          use_or: boolean(),
          negfuncid: non_neg_integer(),
          hashfuncid: non_neg_integer(),
  ...
  (
    ...
    defp encode_negfuncid({acc, acc_size}, msg) do
      if msg.negfuncid == 0 do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_uint32(msg.negfuncid)
    ...
    defp encode_hashfuncid({acc, acc_size}, msg) do
      if msg.hashfuncid == 0 do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_uint32(msg.hashfuncid)
        {[" ", value_bytes | acc], acc_size + 1 + value_bytes_size}
      end
    rescue
      ArgumentError ->
    ...
    defp encode_opfuncid({acc, acc_size}, msg) do
      if msg.opfuncid == 0 do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_uint32(msg.opfuncid)
